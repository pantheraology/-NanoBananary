...
const App: React.FC = () => {
  ...
  const applyWatermarks = useCallback(async (imageUrl: string | null) => {
    ...
    try {
      const invisiblyWatermarked = await embedWatermark(imageUrl, "Nano Bananary");
      const visiblyWatermarked = await addVisibleWatermark(invisiblyWatermarked, "Nano Bananary");
